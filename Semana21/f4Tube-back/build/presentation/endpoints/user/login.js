...
exports.LoginEndpoint = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const loginUC = new login_1.LoginUC(new userDatabase_1.UserDB(), new jwtAuthorizer_1.JwtAuthorizer(), new bcryptServices_1.BcryptService(), new refreshTokenDataBase_1.RefreshTokenDB());
